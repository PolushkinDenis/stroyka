        ...
        <Services image={garage_extension} title="Пристройка гаража" info={info}>
            {
                <div>
                    <p>
                        ...
                        заказать пристройку гараж от представителей компании «Кирстрой», достаточно связаться с менеджером
                    ...
                    <h2>Рекомендации</h2>
                    <p>
                        Существует ряд рекомендаций, которые специалисты компании «Кирстрой» просят выполнить клиента при осуществлении
