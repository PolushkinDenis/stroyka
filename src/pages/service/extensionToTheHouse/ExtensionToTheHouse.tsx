        ...
        <Services image={extensionToTheHouse_img} title="Пристройка к дому" info={info}>
            {
                <div>
                    ...
                    <p>
                        ...
                        дома любого типа в зависимости от ценовой категории, характеристик и других нюансов. Инженеры компании «Кирстрой» выделяют
                    ...
                    <p>
                        Обратившись к представителям компании «Кирстрой» на всей территории Российской Федерации, можно создать индивидуальный проект,
